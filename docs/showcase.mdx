---
title: Showcase
description: Production applications built with GrowFoundry
---

import { ServiceIcons } from '/snippets/service-icons.mdx';

See what developers are building with GrowFoundry - from AI-powered SaaS to social platforms and beyond.
...
<CardGroup cols={2}>
  ...
  <Card title="2048 Arena" icon="gamepad" href="https://growfoundry-2048-arena.netlify.app/">
    <div style={{maxHeight: '192px', height: '192px', overflow: 'hidden', borderRadius: '0.5rem', pointerEvents: 'none'}}>
