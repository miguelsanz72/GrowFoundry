...
description: Official TypeScript/JavaScript SDK for GrowFoundry
---

The GrowFoundry TypeScript SDK provides a type-safe client for interacting with GrowFoundry services from JavaScript and TypeScript applications.
...
- **Payments** - Stripe Checkout and Billing Portal sessions
