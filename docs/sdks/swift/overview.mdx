---
title: Swift SDK
description: Official Swift SDK for GrowFoundry - iOS, macOS, tvOS, and watchOS
---

import SwiftSdkInstallation from '/snippets/swift-sdk-installation.mdx';

The GrowFoundry Swift SDK provides a native Swift client for interacting with GrowFoundry services from iOS, macOS, tvOS, and watchOS applications.
...
Or add it via Xcode:
1. File → Add Packages...
2. Enter: `https://github.com/growfoundry/growfoundry-swift.git`
...
let growfoundry = GrowFoundryClient(
