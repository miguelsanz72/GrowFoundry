---
title: Kotlin SDK
description: Official Kotlin SDK for GrowFoundry - Android and Kotlin Multiplatform
---

import KotlinSdkInstallation from '/snippets/kotlin-sdk-installation.mdx';

The GrowFoundry Kotlin SDK provides a native Kotlin client for interacting with GrowFoundry services from Android applications and Kotlin Multiplatform projects.
