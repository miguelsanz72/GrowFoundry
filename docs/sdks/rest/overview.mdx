---
title: REST API
description: Direct HTTP API access to GrowFoundry services
---

The GrowFoundry REST API provides direct HTTP access to all GrowFoundry services. Use this when you need to integrate with languages or platforms without an official SDK.

## Base URL

```
https://your-app.growfoundry.app
```
