...
```bash
curl -X POST "https://your-app.growfoundry.app/functions/hello-world" \
...
```bash
curl "https://your-app.growfoundry.app/api/functions" \
...
```bash
curl "https://your-app.growfoundry.app/api/functions/hello-world" \
  -H "Authorization: Bearer admin-jwt-token-or-api-key"
```
...
<Note>
Currently, GrowFoundry only supports JavaScript/TypeScript functions running in a Deno environment.
</Note>
...
```bash
curl -X POST "https://your-app.growfoundry.app/api/functions" \
  -H "Authorization: Bearer admin-jwt-token-or-api-key" \
  -H "Content-Type: application/json" \
  -d '{
    "name": "Hello World Function",
...
```bash
curl -X PUT "https://your-app.growfoundry.app/api/functions/hello-world" \
  -H "Authorization: Bearer admin-jwt-token-or-api-key" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE "https://your-app.growfoundry.app/api/functions/old-function" \
  -H "Authorization: Bearer admin-jwt-token-or-api-key"
```
