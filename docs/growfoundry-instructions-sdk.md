# GrowFoundry SDK Documentation - Overview
...
The following is a step-by-step guide to installing and using the GrowFoundry TypeScript SDK for Web applications. If you are building other types of applications, please refer to:
...
const client = createClient({
  baseUrl: 'https://your-app.region.growfoundry.app',  // Your GrowFoundry backend URL
  anonKey: 'your-anon-key-here'       // Get this from backend metadata
});

```

**API BASE URL**: Your API base URL is `https://your-app.region.growfoundry.app`.

## Getting Detailed Documentation

### 🚨 CRITICAL: Always Fetch Documentation Before Writing Code

GrowFoundry provides official SDKs and REST APIs, use them to interact with GrowFoundry services from your application code.
...
Before writing or editing any GrowFoundry integration code, you **MUST** call the `fetch-docs` or `fetch-sdk-docs` MCP tool to get the latest SDK documentation. This ensures you have accurate, up-to-date implementation patterns.

### Use the GrowFoundry `fetch-docs` MCP tool to get specific SDK documentation:
...
### Use the GrowFoundry `fetch-sdk-docs` MCP tool to get specific SDK documentation
...
- Project scaffolding (`download-template`) - Download starter templates with GrowFoundry integration
- Backend setup and metadata (`get-backend-metadata`)
- Database schema management (`run-raw-sql`, `get-table-schema`)
- Storage bucket creation (`create-bucket`, `list-buckets`, `delete-bucket`)
- Serverless function deployment (`create-function`, `update-function`, `delete-function`)
- Frontend deployment (`create-deployment`) - Deploy frontend apps to GrowFoundry hosting
