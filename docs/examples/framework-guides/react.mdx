---
title: React
description: Learn how to create an GrowFoundry project and build a React app using AI
---

import Installation from '/snippets/sdk-installation.mdx';

Learn how to create an GrowFoundry project and build a React app using AI tools like Cursor.
...
export function Sports() {
  ...
  useEffect(() => {
    async function fetchSports() {
      const { data, error } = await growfoundry.database
        .from('sports')
        .select();
