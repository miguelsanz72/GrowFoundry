---
title: Vue
description: Learn how to create an GrowFoundry project and build a Vue app using AI
---

import Installation from '/snippets/sdk-installation.mdx';

Learn how to create an GrowFoundry project and build a Vue app using AI tools like Cursor.
