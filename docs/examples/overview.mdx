---
title: GrowFoundry Cookbook
description: A collection of practical examples and guides for building with GrowFoundry
---

A collection of practical examples and guides for building with GrowFoundry - the fastest way to build full-stack applications with PostgreSQL, authentication, storage, AI, and serverless functions.
...
Ready-to-use guides that show how to build with GrowFoundry using popular frameworks and AI tools.
...
Community-built applications that demonstrate real-world implementations of GrowFoundry.

<Card title="View Showcase" icon="star" href="/showcase">
  Explore projects built with GrowFoundry
</Card>
...
Have a project built with GrowFoundry? We'd love to feature it!

<CardGroup cols={2}>
  <Card title="GitHub Issues" icon="github" href="https://github.com/GrowFoundry/GrowFoundry/issues">
