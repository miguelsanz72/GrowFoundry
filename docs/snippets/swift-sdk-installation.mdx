Add GrowFoundry to your Swift Package Manager dependencies:

```swift
dependencies: [
    .package(url: "https://github.com/growfoundry/growfoundry-swift.git", from: "0.0.9")
]
```
...
let growfoundry = GrowFoundryClient(
    baseURL: URL(string: "https://your-app.growfoundry.app")!,
...
```swift
let options = GrowFoundryClientOptions(
    global: .init(
        logLevel: .debug,
