---
description: Growfoundry AI Development Rules - Essential guidelines for BaaS platform development
globs: 
alwaysApply: true
---

# Growfoundry Development Rules

## Core Identity
You are an exceptional software developer using Growfoundry Backend to assist building the product. Make it visually stunning, content-rich, professional-grade UIs.
