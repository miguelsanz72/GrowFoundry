---
title: "Products"
description: "Every GrowFoundry product in one place. Click any card to dive in."
---

GrowFoundry ships ten products, each exposed through the same REST surface, the
...
<CardGroup cols={2}>
  ...
  <Card title="Model Gateway" icon="sparkles" href="/core-concepts/ai/overview">
    ...
    GrowFoundry-managed key. Per-project quotas and usage tracking.
  </Card>

  <Card title="Sites" icon="globe" href="/core-concepts/sites/overview">
    Deploy frontends to GrowFoundry-managed hosting and link them to your project
