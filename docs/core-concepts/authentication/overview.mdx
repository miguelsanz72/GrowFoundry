...
description: "Use GrowFoundry to authenticate and authorize your users."
---
...
<Frame caption="Configured sign-in methods: email and password, Google, and GitHub OAuth.">
  <img src="/images/authentication-methods.png" alt="GrowFoundry dashboard Auth Methods showing email and password, Google OAuth, and GitHub OAuth" />
</Frame>
...
```mermaid
graph TB
    Client[Client Application] --> SDK[GrowFoundry SDK]
