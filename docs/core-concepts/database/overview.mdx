...
description: "Use GrowFoundry to manage your data."
---
...
<Frame caption="The table editor: typed columns, inline editing, CSV import, and a SQL studio.">
  <img src="/images/database-table-editor.png" alt="GrowFoundry dashboard table editor showing a messages table with typed columns" />
</Frame>
