...
description: "Run long-lived containers next to your GrowFoundry project."
---
...
```mermaid
graph TB
    Dashboard[GrowFoundry Dashboard] --> Service[Compute Service]
    CLI[GrowFoundry CLI] --> Service
