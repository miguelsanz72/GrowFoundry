export const crmSystemPrompt = {
  ...
  prompt: `Build a lightweight CRM app using GrowFoundry as the backend platform with these features:
...
• File attachments stored in GrowFoundry storage and shown on the deal page`,
