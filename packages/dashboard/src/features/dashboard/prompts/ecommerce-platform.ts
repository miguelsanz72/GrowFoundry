export const ecommercePlatformPrompt = {
  ...
  prompt: `Build an app similar to a modern online store using GrowFoundry as the backend platform that has these features:
...
• Stores product images in GrowFoundry storage`,
