export const aiChatbotPrompt = {
  ...
  prompt: `Build an AI chatbot app using GrowFoundry as the backend platform with these features:
• Sign in and sign out before chatting
• Chat window with message history per conversation
• Create and delete conversations
• Upload images in chat and store them in GrowFoundry storage
