export const instagramClonePrompt = {
  ...
  prompt: `Build an app similar to Instagram with a global shared image stream using GrowFoundry as the backend platform that has these features:
• Has a drag and drop box for uploading images to GrowFoundry storage with an optional caption
